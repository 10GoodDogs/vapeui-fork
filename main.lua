...
function lib:Window(text, preset, closebind)
    if game:GetService("CoreGui"):FindFirstChild(text) then
        game:GetService("CoreGui"):FindFirstChild(text):Destroy()
    end
    ui.Name = text
    ...
    function tabhold:Tab(text)
        ...
        function tabcontent:Toggle(text,default, callback)
            ...
            function t:SetToggle(val:boolean)
                toggled = val
                if val == false then
                    TweenService:Create(
                        Toggle,
